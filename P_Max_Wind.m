...
% 选择导体
selected_conductor = 'Horse'; % 可以更改为 'Oak', 'Poplar', 'Upas', 'Rubus', 'Gopher', 'Horse', 'Lynx', 'Moose' 等
...
line_length_km = 50; % 总跨度（利物浦到曼彻斯特），单位：公里
R_s = 180; % 单段水平跨度，单位：米
...
fprintf('单回路最大传输容量 (P_rated_single): %.2f MVA\n', P_rated_single_MVA);
fprintf('双回路最大传输容量 (P_rated_double): %.2f MVA\n', P_rated_double_MVA);
